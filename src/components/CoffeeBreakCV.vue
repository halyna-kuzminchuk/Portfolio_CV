<template>
  <section class="dino w-full mt-25 md:mt-50 overflow-hidden" id="cv">
    <div
      class="p-4 flex w-full max-w-screen-xl flex-col items-center md:flex-row md:gap-40 xl:px-16 bg-gradient-to-br from-[#D9D9D9] to-[#EDD0C6] md:rounded-r-sm"
    >
      <div
      ...
      >
        ...
        <div
          class="line_left py-2 max-w-fit max-h-fit md:col-start-1 md:row-start-2 border-b-2 border-[color:var(--color-brown)] md:pr-6"
        >
          <p>More coffee?</p>
        </div>

        <!-- Dino Image: Center Column, Rows 1-2 -->
        <div
          class="md:col-start-2 md:row-span-2 flex flex-col items-center max-w-fit max-h-fit relative"
        >
          <!-- Bean Rain Container -->

          <svg
            :class="{ hidden: !coffeeVisible }"
            class="absolute insert z-30"
            id="Beans_rain"
            data-name="Layer 2"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 168.45 127.64"
          >
            <defs></defs>
            <g id="Layer_1-2" data-name="Layer 1">
              <g id="_Beans_" data-name="&amp;lt;Beans&amp;gt;">
                <g id="Bean_4">
                  <path
                    class="cls-1"
                    d="M76.09,28.85c14.86.9,10.54,18.52,30.62,22.79-4.67,6.31-15.24,6-23.53-.19-8.29-6.19-11.77-16.3-7.1-22.61Z"
                  />
                  <path
                    class="cls-1"
                    d="M107.51,50.83c-14.82-1.47-9.84-18.91-29.74-23.95,4.9-6.12,15.45-5.42,23.51,1.08,8.05,6.5,11.14,16.74,6.23,22.86Z"
                  />
                </g>
                <g id="Bean_5">
                  <path
                    class="cls-1"
                    d="M2.1,6.18c14.86.9,10.54,18.52,30.62,22.79-4.67,6.31-15.24,6-23.53-.19C.9,22.6-2.58,12.49,2.1,6.18Z"
                  />
                  <path
                    class="cls-1"
                    d="M33.51,28.16c-14.82-1.47-9.84-18.91-29.74-23.95,4.9-6.12,15.45-5.42,23.51,1.08,8.05,6.5,11.14,16.74,6.23,22.86Z"
                  />
                </g>
                <g id="Bean_2">
                  <path
                    class="cls-1"
                    d="M67.93,100.25c14.86.9,10.54,18.52,30.62,22.79-4.67,6.31-15.24,6-23.53-.19-8.29-6.19-11.77-16.3-7.1-22.61Z"
                  />
                  <path
                    class="cls-1"
                    d="M99.34,122.23c-14.82-1.47-9.84-18.91-29.74-23.95,4.9-6.12,15.45-5.42,23.51,1.08,8.05,6.5,11.14,16.74,6.23,22.86Z"
                  />
                </g>
                <g id="Bean_3">
                  <path
                    class="cls-1"
                    d="M134.68,18.24c14.86.9,10.54,18.52,30.62,22.79-4.67,6.31-15.24,6-23.53-.19-8.29-6.19-11.77-16.3-7.1-22.61Z"
                  />
                  <path
                    class="cls-1"
                    d="M166.1,40.23c-14.82-1.47-9.84-18.91-29.74-23.95,4.9-6.12,15.45-5.42,23.51,1.08,8.05,6.5,11.14,16.74,6.23,22.86Z"
                  />
                </g>
                <g id="Bean_1" data-name="&amp;lt;Bean_1&amp;gt;">
                  <path
                    class="cls-1"
                    d="M131.15,83.46c14.86.9,10.54,18.52,30.62,22.79-4.67,6.31-15.24,6-23.53-.19-8.29-6.19-11.77-16.3-7.1-22.61Z"
                  />
                  <path
                    class="cls-1"
                    d="M162.56,105.45c-14.82-1.47-9.84-18.91-29.74-23.95,4.9-6.12,15.45-5.42,23.51,1.08,8.05,6.5,11.14,16.74,6.23,22.86Z"
                  />
                </g>
              </g>
            </g>
            ...
            <g id="Layer_1-2" data-name="Layer 1">
              <g id="Dino">
                ...
                <g id="Body">
                  ...
                  <path
                    class="cls-6"
                    d="M737.39,584.55c-.45-.51-.65-1.05-.67-1.57-2.06-4.57-3.95-9.4-5.52-14.26-.37-.24-.71-.57-.97-1.03-1.49-2.7-3.76-4.69-6.6-5.87-4.21-1.75-6.18-.95-6.3,3.61-.08,3.23.73,6.45,1.41,9.59.53,2.42.69,5.38,1.98,7.56.71,1.2.31,2.27-.5,2.94,5.95.26,11.95-.04,18.09-.16l-.65-.51-.27-.31Z"
                  />
                  <path
                    class="cls-6"
                    d="M544.62,572.31c-.29-.24-.54-.57-.72-1-1.61-3.82-3.82-8.07-6.74-11.08-6.24-6.43-9.47-.68-10.89,4.82-1.17,4.54-.23,9.01.11,13.58.19,2.54-.07,6.04.8,8.47.6,1.69-.44,3.1-1.74,3.62,1.65-.03,3.28-.05,4.96-.07,5.92-.08,11.86-.28,17.79-.48-2.3-4.89-3.18-12.35-3.54-17.53l-.02-.33Z"
                  />
                  <path
                    class="cls-6"
                    d="M556.05,462.79c-26.31.82-51.19.1-75.6-10.24-3.6,7.88-8.06,16.46-14.62,19.48-.65.3-1.25.28-1.78.13,1.19,2,2.36,3.99,3.48,5.88,4.11,6.88,7.47,13.98,10.75,21.27,7.07,15.7,11.8,32.45,13.18,49.65.67,8.32.38,16.8.3,25.14-.03,4.02-1.16,10.11,1.82,13.53,4,4.58,11.38,2.68,16.6,2.97,4.5.25,8.91.23,13.34.17-.53-.23-1.01-.65-1.27-1.4-1.9-5.31-1.71-12.46-2.03-18.09-.3-5.24,1.04-12.1,4.75-16.06,7.26-7.75,14.75-1.23,19.63,6.06.29-2.07.83-4.07,1.8-5.86,4.35-8,12.49-4.24,18.2,1.47.6-5.1,3.31-10.27,7.69-9.96-7.83-3.06-15.5-6.04-17.72-15.32-3.85-16.09,4.41-30.44,5.17-46.12.31-6.36.54-13.16-.53-19.45-.26-1.51-.58-3-.9-4.49-.48.7-1.21,1.23-2.25,1.26Z"
                  />
                  <path
                    class="cls-6"
        ...
        <div
          class="line_right text-right py-2 order-4 md:order-2 max-h-fit max-w-fit md:col-start-3 md:row-start-1 border-b-2 border-[color:var(--color-brown)]"
        >
          <p>
            skim through my
            <span class="text-[color:var(--color-orange)] text-3xl px-2">CV</span>
          </p>
        </div>

        <!-- Line 3: Full Bottom Row -->
        <div class="line_final py-2 order-2 md:order-4 md:col-span-3 md:row-start-3">
          <p class="text-[color:var(--color-orange)] text-center">
      ...
      <!-- PDF Icon -->
      <div class="py-6 pl-6 bg-[color:var(--color-brown)] shadow-xl rounded-sm">
        <a
          href="https://indd.adobe.com/view/e48f3a5e-3745-454f-98d5-32285a2abe4f"
          target="_blank"
...
const coffeeVisible = ref(false)

onMounted(() => {
  const beans = ['#Bean_1', '#Bean_2', '#Bean_3', '#Bean_4', '#Bean_5']
  const maxX = window.innerWidth * 0.5
  const maxY = window.innerHeight * 0.5

  let beansStarted = false

  // Main dino timeline
  const tl = gsap.timeline({
    scrollTrigger: {
      trigger: '.dino',
      start: 'top center', //when the top of section touches the center
      end: 'bottom top', //when the bottom of section touches the top of the viewport
  ...
  function startBeanRain() {
    ...
    beans.forEach((selector) => {
      const bean = document.querySelector(selector)
      if (bean) {
        const beanTl = gsap.timeline({
          repeat: -1,
          repeatDelay: 0.1 + Math.random(),
        })
